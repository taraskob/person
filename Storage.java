...
public class Storage {
    ...
    void writeData(Object input) throws IllegalAccessException {
      ...
      void sourcexists(String fileName) throws IOException {
    ...
    String getFilename(Class classname) {
        return classname.getName() + ".dat";
    }
}
